...
async def submit_form(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        yangi_anketa = Application(
            ...
            telegram_username=html.escape(str(validated_data.telegram_user)),
            ...
            phone=html.escape(str(validated_data.telefon)),
            additional_phone=html.escape(str(validated_data.qoshimcha_tel)) if validated_data.qoshimcha_tel else "",
